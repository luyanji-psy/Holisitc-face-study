...
faceRect = [0 0 size(faces(1).matrix,2) size(faces(1).matrix,1)];   % face size, 200 * 256
...
lineRect = [screenX/2-225 screenY/2-1 screenX/2+225 screenY/2+2];   % width of white line is 3 pixels
