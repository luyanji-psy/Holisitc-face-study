...
```{r message=FALSE}
# Sensitivity d'
emm_fi <- contrast(emm_resp, interaction = "pairwise", by = c("Cue", "Congruency"), infer=TRUE, adjust = "Tukey")
emm_fi[1:4]
```

```{r message=FALSE}
# Accuracy for same trials only
temp <- contrast(emm_resp, method = "pairwise", simple = "Alignment", infer = TRUE)
temp[1:4]
